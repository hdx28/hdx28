!(function () {
   ...
   */ var d,
    ...
    Ue = function (t, e, i, r) {
      ...
      return (
        Et(t, function (t) {
          for (var e in ((Be[t] = ft[t] = s),
          (Be[(n = t.toLowerCase())] = i),
          s))
            Be[
      ...
      return (
        ...
        (e.startTime = function (t) {
          if (arguments.length) {
            ...
            return (
              e && (e._sort || !this.parent) && ie(e, this, t - this._delay),
              this
            );
          }
          return this._start;
  ...
  var Je = (function (t) {
    ...
    return (
      (i.to = function (t, e, i) {
        return (
          new ai(t, It(arguments, 0, this), he(this, J(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.from = function (t, e, i) {
        return (
          new ai(t, It(arguments, 1, this), he(this, J(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.fromTo = function (t, e, i, r) {
        return (
          new ai(t, It(arguments, 2, this), he(this, J(e) ? arguments[4] : r)),
          this
        );
      }),
      ...
      (i.render = function (t, e, i) {
        ...
        if (y !== this._tTime || i || w) {
          if (
            ...
            if (
              ...
              if (
                ...
                (g = this._tDur),
                b &&
                  ((this._lock = 2), (m = x ? v : -1e-4), this.render(m, !0)),
                (this._lock = 0),
                !this._ts && !u)
              )
                return this;
          ...
          if (
            ...
            for (n = this._first; n; ) {
              if (
                ((s = n._next), (n._act || r >= n._start) && n._ts && h !== n)
              ) {
      ...
      (i.addPause = function (t, e, i) {
        ...
        return (
          (r.data = "isPause"), (this._hasPause = 1), ie(this, r, he(this, t))
        );
      }),
        ...
        for (
          ...
          if (
            ...
            l &&
              ...
              ((e._pt = o =
                new xi(e._pt, a, c.name, 0, 1, c.render, c, 0, c.priority)),
            ...
            for (s in r)
              Ot[s] && (c = ii(s, r, e, _, a, I))
                ? c.priority && (u = 1)
                : (p[s] = o =
                    ei.call(e, a, s, "get", r[s], _, I, 0, v.stringFilter));
          ...
          if (
            ...
            if (
              ...
              if (
                (D && c in D
                  ? ((s =
                      "function" == typeof D[c] ? D[c].call(i, r, t, n) : D[c]),
                    ...
                    (x = void 0),
                      ...
                      g.svg
                        ...
                        : ((f = parseFloat(o.split(" ")[2]) || 0) !==
                            g.zOrigin && cr(this, g, "zOrigin", g.zOrigin, f),
    ...
    initEvents() {
      window.addEventListener("resize", () => this.calculateSizePosition()),
        ...
        this.DOM.el.addEventListener("mouseleave", () => {
          this.stopRendering(),
            (this.renderedStyles.tx.previous = this.renderedStyles.ty.previous =
              0);
        });
    }
    loopRender() {
  ...
  (Wr = Qr),
    (Gr = function () {
      ...
      return (
        p(g), p(y), p(O), p(M), p(T), p(D), p(k), p(C), p(S), p(E), p(L), w
      );
    }),
  ...
  class Jr {
    constructor(t, e) {
      (this.DOM = { el: t }),
        ...
        (this.DOM.enterActionSVGCircle =
          this.DOM.enterAction.querySelector("circle")),
    ...
    editContentLayout() {
      (this.DOM.contentEl = document.querySelector(this.contentId)),
        (this.DOM.contentElHeading =
          this.DOM.contentEl.querySelector(".heading")),
